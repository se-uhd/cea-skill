...
Read `references/narrow-claims.md`, the reference. It defines main results, broad statements, narrow claims, and rejected candidates. The steps below name its sections in quotation marks, as in "Splitting".
