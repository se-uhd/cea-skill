...
if [ ! -f "$papers/sliwerski-msr-2005.pdf" ]; then
    echo "missing $papers/sliwerski-msr-2005.pdf" >&2
    exit 1
fi
mkdir -p evals/papers
cp "$papers/sliwerski-msr-2005.pdf" evals/papers/sliwerski-msr-2005.pdf
